...
from captionvqa.datasets.multi_dataset_loader import MultiDatasetLoader
from captionvqa.utils.build import build_multiple_datamodules, build_test_reporter
...
class DatasetLoader:
    def __init__(self, config):
        ...
        warnings.warn(
            ...
            "Please use captionvqa.datasets.multi_datamodule.MultiDataModule instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        self.config = config
