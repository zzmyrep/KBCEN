...
from captionvqa.common.sample import convert_batch_to_sample_list
from captionvqa.utils.configuration import get_captionvqa_env
from captionvqa.utils.distributed import gather_tensor, is_main
from captionvqa.utils.file_io import PathManager
from captionvqa.utils.general import ckpt_name_from_core_args, foldername_from_config_override
...
class TestReporter(Dataset):
    ...
    def __init__(
        ...
        self.report_folder_arg = get_captionvqa_env(key="report_dir")
