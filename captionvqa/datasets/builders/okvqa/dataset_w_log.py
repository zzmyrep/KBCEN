...
import torch
from captionvqa.common.sample import Sample
from captionvqa.common.typings import captionvqaDatasetConfigType
from captionvqa.datasets.builders.okvqa.database import OKVQAAnnotationDatabase
from captionvqa.datasets.captionvqa_dataset import captionvqaDataset
from captionvqa.datasets.processors import GraphVQAAnswerProcessor

import logging
logger = logging.getLogger(__name__)

class OKVQADataset(captionvqaDataset):
    def __init__(
        self,
        config: captionvqaDatasetConfigType,
        dataset_type: str,
        index: int,
        *args,
        **kwargs,
    ...
    def __getitem__(self, idx: int) -> Type[Sample]:
        ...
        text_processor_argument = {"text": sample_info["question_str"] + ' ' + sample_info["caption"]}
