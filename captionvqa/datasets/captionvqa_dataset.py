...
from captionvqa.datasets.base_dataset import BaseDataset
from captionvqa.datasets.databases.annotation_database import AnnotationDatabase
from captionvqa.datasets.databases.features_database import FeaturesDatabase
from captionvqa.datasets.databases.image_database import ImageDatabase


class captionvqaDataset(BaseDataset):
