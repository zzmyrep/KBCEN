...
import torch
from captionvqa.common.sample import SampleList, convert_batch_to_sample_list
from captionvqa.datasets import iteration_strategies
from captionvqa.utils.build import build_dataloader_and_sampler, build_dataset
from captionvqa.utils.dataset import dataset_list_from_config
from captionvqa.utils.distributed import (
    broadcast_scalar,
    get_world_size,
    is_dist_initialized,
    is_main,
...
from captionvqa.utils.general import get_batch_size, get_current_device
