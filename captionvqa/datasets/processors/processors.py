...
import numpy as np
import torch
from captionvqa.common.constants import IMAGE_COLOR_MEAN, IMAGE_COLOR_STD
from captionvqa.common.registry import registry
from captionvqa.common.typings import ProcessorConfigType
from captionvqa.utils.configuration import get_captionvqa_cache_dir, get_captionvqa_env
from captionvqa.utils.distributed import is_main, synchronize
...
from captionvqa.utils.vocab import Vocab, WordToVectorDict
...
class FastTextProcessor(VocabProcessor):
    ...
    def _try_download(self):
        ...
        if not PathManager.exists(model_file):
            model_file = os.path.join(get_captionvqa_cache_dir(), model_file)
    ...
    def _download_model(self):
        ...
        model_file_path = os.path.join(get_captionvqa_cache_dir(), "wiki.en.bin")
        ...
        import requests
        from captionvqa.common.constants import FASTTEXT_WIKI_URL
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        if os.path.exists(config.graph_vocab_file):
            ...
            graph_vocab_file = os.path.join(
                os.getenv("captionvqa_DATA_DIR"), "datasets", config.graph_vocab_file
            )
...
class SimpleWordProcessor(BaseProcessor):
    ...
    def __init__(self, *args, **kwargs):
        from captionvqa.utils.text import word_tokenize
...
class SimpleSentenceProcessor(BaseProcessor):
    ...
    def __init__(self, *args, **kwargs):
        from captionvqa.utils.text import tokenize
...
class BBoxProcessor(VocabProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        from captionvqa.utils.dataset import build_bbox_tensors
...
class PhocProcessor(VocabProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        from captionvqa.utils.phoc import build_phoc
...
class DETRImageAndTargetProcessor(BaseProcessor):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        from captionvqa.datasets.processors import detection_transforms as T
