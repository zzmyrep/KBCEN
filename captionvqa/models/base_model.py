...
"""
Models built in captionvqa need to inherit ``BaseModel`` class and adhere to
a fixed format. To create a model for captionvqa, follow this quick cheatsheet.
...
from captionvqa.common.registry import registry
from captionvqa.common.report import Report
from captionvqa.common.sample import SampleList, to_device
from captionvqa.modules.losses import LossConfig, Losses
from captionvqa.utils.checkpoint import load_pretrained_model
from captionvqa.utils.checkpoint_updater import captionvqaToPLCheckpointUpdater
from captionvqa.utils.download import download_pretrained_model
from captionvqa.utils.file_io import PathManager
from captionvqa.utils.general import get_current_device
...
class BaseModel(pl.LightningModule):
    """For integration with captionvqa's trainer, datasets and other features,
    ...
    def on_load_checkpoint(self, checkpoint: Dict[str, Any]) -> None:
        ...
        if self.checkpoint_updater is None:
            self.checkpoint_updater = captionvqaToPLCheckpointUpdater()
    ...
    def build_meters(self, run_type):
        from captionvqa.utils.build import build_meters
    ...
    def init_losses(self):
        ...
        captionvqa internally after building the model.
        """
    ...
    def configure_optimizers(self):
        ...
        from captionvqa.utils.build import build_lightning_optimizers
