...
from captionvqa.models.pythia import Pythia
from captionvqa.modules.embeddings import ProjectionEmbedding
from captionvqa.utils.transform import transform_to_batch_sequence
...
@registry.register_model("captionvqa_bert")
class captionvqaBert(Pythia):
    def __init__(self, config):
        super().__init__(config)

    @classmethod
    def config_path(cls):
        return "configs/models/captionvqa_bert/defaults.yaml"
