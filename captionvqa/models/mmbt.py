...
from captionvqa.models.interfaces.mmbt import MMBTGridHMInterface
from captionvqa.modules.encoders import (
    EncoderFactory,
    ImageEncoderFactory,
    ImageEncoderTypes,
...
from captionvqa.modules.hf_layers import replace_with_jit
...
class MMBTForPreTraining(nn.Module):
    def __init__(self, config, *args, **kwargs):
        ...
        pretraining_module = BertForPreTraining.from_pretrained(
            ...
            cache_dir=os.path.join(get_captionvqa_cache_dir(), "distributed_{}".format(-1)),
        )
