...
from captionvqa.models.transformers.heads.utils import build_heads_dict
from captionvqa.modules.encoders import TransformerEncoder, ViTEncoder
from captionvqa.modules.losses import captionvqaLoss
from captionvqa.utils.build import build_encoder
from captionvqa.utils.modeling import get_bert_configured_parameters
...
class ViLT(BaseModel):
    ...
    def init_losses(self):
        ...
        for loss_name, loss_config in loss_configs.items():
            self.losses[loss_name] = captionvqaLoss(loss_config)
