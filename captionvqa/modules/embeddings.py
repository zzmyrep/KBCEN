...
import numpy as np
import torch
from captionvqa.modules.attention import AttentionLayer, SelfAttention, SelfGuidedAttention
from captionvqa.modules.bottleneck import MovieBottleneck
from captionvqa.modules.layers import AttnPool1d, Identity
from captionvqa.utils.file_io import PathManager
from captionvqa.utils.vocab import Vocab
