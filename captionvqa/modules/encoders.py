...
from captionvqa.models.frcnn import GeneralizedRCNN
from captionvqa.modules.embeddings import ProjectionEmbedding, TextEmbedding
from captionvqa.modules.hf_layers import BertModelJit
from captionvqa.modules.layers import Identity
from captionvqa.utils.build import build_image_encoder, build_text_encoder
...
# Taken from None/mmbt with some modifications
...
class PytorchVideoEncoder(Encoder):
    ...
    PYTORCHVIDEO_REPO = "None/pytorchvideo:main"
...
class ViTEncoder(Encoder):
    ...
    def _model_class(self):
        from captionvqa.modules.vit import ViTModel
