...
captionvqa using the following example.
...
from captionvqa.common.registry import registry
from captionvqa.utils.distributed import gather_tensor_along_batch_with_backward, get_rank
...
class Losses(nn.Module):
    ...
    def __init__(self, loss_list: List[Union[str, LossConfig]]):
        ...
        for loss in loss_list:
            self.losses.append(captionvqaLoss(loss))
...
class captionvqaLoss(nn.Module):
    """Internal captionvqa helper and wrapper class for all Loss classes.
    ...
    .. note::
        ...
        Since, ``captionvqaLoss`` is used by the ``Losses`` class, end user
...
class MultiLoss(nn.Module):
    ...
    def __init__(self, params):
        ...
        for loss_params in params["params"]:
            ...
            loss_fn = captionvqaLoss(loss_params)
