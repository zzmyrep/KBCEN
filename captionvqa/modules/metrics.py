...
from captionvqa.datasets.processors.processors import EvalAIAnswerProcessor
...
class TextVQAAccuracy(BaseMetric):
    def __init__(self):
        ...
        import captionvqa.utils.m4c_evaluators as evaluators
    ...
    def calculate(self, sample_list, model_output, *args, **kwargs):
        ...
        predictions = []
        from captionvqa.utils.distributed import byte_tensor_to_object
...
class DetectionMeanAP(BaseMetric):
    ...
    **Key:** ``detection_mean_ap``
    ...
    def calculate(
        ...
        # mAP evaluation)
        from captionvqa.utils.distributed import broadcast_tensor, is_master
