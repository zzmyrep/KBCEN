...
from captionvqa.datasets.lightning_multi_datamodule import LightningMultiDataModule
from captionvqa.modules.metrics import Metrics
from captionvqa.trainers.base_trainer import BaseTrainer
from captionvqa.trainers.lightning_core.loop_callback import LightningLoopCallback
from captionvqa.utils.build import build_lightning_model
from captionvqa.utils.checkpoint import (
    get_ckpt_from_path,
    get_ckpt_path_from_folder,
    get_config_from_folder_or_ckpt,
)
from captionvqa.utils.checkpoint_updater import is_model_only_checkpoint
from captionvqa.utils.configuration import get_captionvqa_env
from captionvqa.utils.download import download_pretrained_model
from captionvqa.utils.file_io import PathManager
from captionvqa.utils.general import get_max_updates, print_model_parameters
from captionvqa.utils.logger import TensorboardLogger, setup_output_folder
...
class LightningTrainer(BaseTrainer):
    ...
    def _load_trainer(self):
        ...
        self.trainer = Trainer(
            ...
            default_root_dir=get_captionvqa_env(key="log_dir"),
    ...
    def _load_loggers(self) -> None:
        ...
        if self.training_config.tensorboard:
            ...
            env_tb_logdir = get_captionvqa_env(key="tensorboard_logdir")
            if env_tb_logdir:
    ...
    def get_checkpoint_data(self) -> Dict[str, Any]:
        ...
        path = os.path.join(get_captionvqa_env(key="save_dir"), suffix)
        ckpt_filepath = None
    ...
    def is_zoo_path(self, path) -> bool:
        from captionvqa.utils.configuration import get_captionvqa_env, load_yaml

        model_zoo = load_yaml(get_captionvqa_env(key="model_zoo"))
    ...
    def configure_checkpoint_callbacks(self) -> List[ModelCheckpoint]:
        train_callback = ModelCheckpoint(
            ...
            dirpath=get_captionvqa_env(key="save_dir"),
