...
import torch
from captionvqa.common.meter import Meter
from captionvqa.common.registry import registry
from captionvqa.datasets.iteration_strategies import (
    ConstantIterationStrategy,
    IterationStrategy,
    SizeProportionalIterationStrategy,
)
from captionvqa.datasets.processors.processors import Processor
from captionvqa.utils.configuration import Configuration, get_global_config
from captionvqa.utils.distributed import is_dist_initialized, is_main, is_xla, synchronize
from captionvqa.utils.general import get_optimizer_parameters
...
def build_lightning_model(
    config: Union[DictConfig, "captionvqa.models.base_model.BaseModel.Config"],
    checkpoint_path: str = None,
) -> "captionvqa.models.base_model.BaseModel":
...
def build_dataset(
    ...
    from captionvqa.utils.configuration import load_yaml_with_defaults
...
def build_multiple_datamodules(
    ...
    for dataset in dataset_list:  # datasets=okvqa
...
def build_dataloader_and_sampler(
    ...
    """
    from captionvqa.common.batch_collator import BatchCollator
...
def build_classifier_layer(config, *args, **kwargs):
    from captionvqa.modules.layers import ClassifierLayer
...
def build_text_encoder(config, *args, **kwargs):
    ...
    try:
        from captionvqa.modules.fb.encoders import TextEncoderFactory
    except ImportError:
        from captionvqa.modules.encoders import TextEncoderFactory
...
def build_image_encoder(config, direct_features=False, **kwargs):
    """Deprecated, please do not use"""
    from captionvqa.modules.encoders import ImageEncoderFactory, ImageFeatureEncoderFactory
...
def build_encoder(config: Union[DictConfig, "captionvqa.modules.encoders.Encoder.Config"]):
