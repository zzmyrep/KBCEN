...
# copied from https://github.com/None/vissl/blob/master/vissl/utils/distributed_gradients.py
...
def broadcast_xla_master_model_param(model):
    ...
    xm.mark_step()
    xm.rendezvous("captionvqa.trainers.core.device.broadcast_xla_master_model_param")
    logger.info("Done!")
