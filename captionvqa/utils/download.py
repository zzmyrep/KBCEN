...
# adapted for captionvqa use cases.
...
from captionvqa.utils.general import get_absolute_path
...
class DownloadableFile:
    ...
    Originally taken from ParlAI, this file has been modified for captionvqa specific
    use cases.
    ...
    captionvqa_PREFIX = "captionvqa://"
    captionvqa_PREFIX_REPLACEMENT = "https://dl.fbaipublicfiles.com/captionvqa/data/"
    ...
    def _parse_url(self, url):
        if url.find(self.captionvqa_PREFIX) == -1:
            return url
        else:
            return self.captionvqa_PREFIX_REPLACEMENT + url[len(self.captionvqa_PREFIX) :]
...
def download_pretrained_model(model_name, *args, **kwargs):
    ...
    data_dir = get_absolute_path(get_captionvqa_env("data_dir"))
    ...
    try:
        ...
        print(f"No such model name {model_name} defined in captionvqa zoo")
        raise e
