...
from captionvqa.utils.build import build_config, build_trainer
from captionvqa.utils.configuration import Configuration
from captionvqa.utils.distributed import distributed_init, get_rank, infer_init_method, is_xla
from captionvqa.utils.env import set_seed, setup_imports
from captionvqa.utils.flags import flags
from captionvqa.utils.general import log_device_names
from captionvqa.utils.logger import setup_logger, setup_very_basic_config
...
def main(configuration, init_distributed=False, predict=False):
    ...
    logger = logging.getLogger("captionvqa_cli.run")
...
def run(opts: typing.Optional[typing.List[str]] = None, predict: bool = False):
    ...
    # Do set runtime args which can be changed by captionvqa
