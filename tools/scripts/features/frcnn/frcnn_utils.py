...
captionvqa_cache_home = get_captionvqa_cache_dir()
...
default_cache_path = os.path.join(captionvqa_cache_home, "transformers")
...
# TODO use captionvqa's download functionality
def cached_path(
    url_or_filename,
    cache_dir=None,
